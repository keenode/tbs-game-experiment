...
gulp.task('default',
    function(cb) {
        ...
        runSequence(
            'dev:clear',
            ['dev:css', 'jshint', 'dev:js', 'dev:views', 'dev:imagemin', 'dev:videos', 'dev:fonts', 'dev:favicons', 'dev:rootfiles'],
            'dev:inject',
            'dev:connect',
            'dev:watch',
        cb);
...
gulp.task('prod',
    function(cb) {
        ...
        runSequence(
            'prod:clear',
            ['prod:css', 'prod:js', 'prod:views', 'prod:imagemin', 'prod:videos', 'prod:fonts', 'prod:favicons', 'prod:rootfiles'],
            'prod:inject',
            'prod:connect',
            'prod:watch',
        cb);
